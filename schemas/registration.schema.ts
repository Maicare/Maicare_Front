...
export const createRegistrationSchema = z.object({
  application_date: z.string().min(1, "Aanvraagdatum is verplicht"),
  ...
  client_bsn_number: z.string().min(1, "BSN-nummer is verplicht"),
  client_city: z.string().min(1, "Stad is verplicht"),
  client_email: z.string().email("Ongeldig e-mailadres").min(1, "E-mailadres is verplicht"),
  client_first_name: z.string().min(1, "Voornaam is verplicht"),
  client_gender: z.string().min(1, "Geslacht is verplicht"),
  client_house_number: z.string().min(1, "Huisnummer is verplicht"),
  client_last_name: z.string().min(1, "Achternaam is verplicht"),
  client_nationality: z.string().min(1, "Nationaliteit is verplicht"),
  client_phone_number: z.string().min(1, "Telefoonnummer is verplicht"),
  client_postal_code: z.string().min(1, "Postcode is verplicht"),
  client_street: z.string().min(1, "Straat is verplicht"),
  ...
  education_mentor_email: z.string().email("Ongeldig mentor e-mailadres").optional(),
  ...
  guardian1_email: z.string().email("Ongeldig voogd e-mailadres").optional(),
  ...
  guardian2_email: z.string().email("Ongeldig voogd e-mailadres").optional(),
  ...
  referrer_email: z.string().email("Ongeldig verwijzer e-mailadres").min(1, "Verwijzer e-mailadres is verplicht"),
  referrer_first_name: z.string().min(1, "Verwijzer voornaam is verplicht"),
  referrer_job_title: z.string().min(1, "Functietitel is verplicht"),
  referrer_last_name: z.string().min(1, "Verwijzer achternaam is verplicht"),
  referrer_organization: z.string().min(1, "Organisatie is verplicht"),
  referrer_phone_number: z.string().min(1, "Telefoonnummer is verplicht"),

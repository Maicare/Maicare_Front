...
const itemVariants: Variants = {
  ...
  visible: {
    ...
    transition: {
      type: "spring",
      stiffness: 200, // High stiffness
      damping: 3,     // Low damping
      mass: 0.3,     // Low mass
    }
  }
};
  ...
  return (
    ...
    >
      ...
      <motion.div variants={itemVariants} className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">{t("dashboard.adminDashboard")}</h1>
      ...
      <motion.div variants={itemVariants} className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card className="bg-gradient-to-br from-blue-50 to-blue-100 border-blue-200 shadow-sm">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">{t("dashboard.metrics.totalRevenue")}</CardTitle>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {t("dashboard.metrics.fromPayments",{count:latestPayments?.length || 0})}
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-gradient-to-br from-green-50 to-green-100 border-green-200 shadow-sm">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">{t("dashboard.metrics.activeClients")}</CardTitle>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {t("dashboard.metrics.urgentCases",{count:totalDischargeCount?.urgent_cases_count || 0})}
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-gradient-to-br from-amber-50 to-amber-100 border-amber-200 shadow-sm">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">{t("dashboard.metrics.pendingInvoices")}</CardTitle>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {t("dashboard.metrics.outstanding",{amount:(outstandingAmount).toFixed(2) || 0})}
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-gradient-to-br from-purple-50 to-purple-100 border-purple-200 shadow-sm">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">{t("dashboard.metrics.upcomingAppointments")}</CardTitle>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {t("dashboard.metrics.today",{count:upcomingAppointments?.filter(a => new Date(a.start_time) < new Date(Date.now() + 86400000)).length || 0})}
            </p>
          </CardContent>
        </Card>
      </motion.div>
          ...
          <Card className="h-full">
            <CardHeader className="pb-3">
              <div className="flex justify-between items-center">
                <div>
                  <CardTitle>{t("dashboard.discharge.overview")}</CardTitle>
                  <CardDescription>
                    {dischargeOverview?.filter(d => d.contract_status === "terminated" || d.contract_status === "stoped").length || 0}
                    clients ending contracts soon.
                    {t("dashboard.discharge.clientsEndingContracts",{count:dischargeOverview?.filter(d => d.contract_status === "terminated" || d.contract_status === "stoped").length || 0})}
                  </CardDescription>
                </div>
              ...
              <div className="space-y-4 p-4">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground mt-1">
                          {t("dashboard.discharge.endsOn",{duration:new Date(discharge.contract_end_date).toLocaleDateString()})}
                        </p>
                      </div>
                    </div>
                ...
                {(!dischargeOverview || dischargeOverview.length === 0) && (
                  <div className="text-center py-6 text-muted-foreground">
                    {t("dashboard.discharge.noData")}
                  </div>
                )}
              </div>
              <div className="border-t p-4">
                <Button variant="outline" className="w-full">
                  {t("dashboard.discharge.viewAll")}
        ...
        <motion.div variants={itemVariants} className="col-span-3 h-full">
          <Card className="border-rose-100 h-full">
            <CardHeader className="pb-3">
              <div className="flex justify-between items-center">
                <div>
                  <CardTitle>{t("dashboard.discharge.employeeEndingContracts")}</CardTitle>
                  <CardDescription>
                    {t("dashboard.discharge.employeeContractsEnding",{count:employeeEndingContracts?.length || 0})}
                  </CardDescription>
                </div>
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground mt-1">
                           {t("dashboard.discharge.endsOn",{duration:getTimeLeft(new Date(employee.contract_end_date).toLocaleDateString())})}
                        </p>
                      </div>
                    </div>
        ...
        <motion.div variants={itemVariants} className="col-span-3 h-full">
          <Card className="h-full">
            <CardHeader className="pb-3">
              <div className="flex justify-between items-center">
                <div>
                  <CardTitle>{t("dashboard.payments.latest")}</CardTitle>
                  <CardDescription>{t("dashboard.payments.recent")}</CardDescription>
                </div>
        ...
        <motion.div variants={itemVariants} className="col-span-4 h-full">
          <Card className="h-full">
            <CardHeader className="pb-3">
              <div className="flex justify-between items-center">
                <div>
                  <CardTitle>{t("dashboard.metrics.upcomingAppointments")}</CardTitle>
                  <CardDescription>{t("dashboard.appointments.next")}</CardDescription>
                </div>
      ...
      <motion.div variants={itemVariants}>
        <Card>
          <CardHeader>
            <div className="flex justify-between items-center">
              <div>
                <CardTitle>{t("dashboard.discharge.statistics")}</CardTitle>
                <CardDescription>{t("dashboard.discharge.overview")}</CardDescription>
              </div>
          ...
          <CardContent>
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
              <div className="flex flex-col items-center justify-center p-4 border rounded-lg">
                ...
                <p className="text-sm text-muted-foreground text-center">{t("dashboard.discharge.totalDischarges")}</p>
              </div>
              ...
              <div className="flex flex-col items-center justify-center p-4 border rounded-lg">
                ...
                <p className="text-sm text-muted-foreground text-center">{t("dashboard.discharge.urgentCases")}</p>
              </div>
              ...
              <div className="flex flex-col items-center justify-center p-4 border rounded-lg">
                ...
                <p className="text-sm text-muted-foreground text-center">{t("dashboard.discharge.contractEnds")}</p>
              </div>
              ...
              <div className="flex flex-col items-center justify-center p-4 border rounded-lg">
                ...
                <p className="text-sm text-muted-foreground text-center">{t("dashboard.discharge.statusChanges")}</p>
              </div>
            </div>
          </CardContent>
        </Card>

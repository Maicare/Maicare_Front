            ...
            <CardHeader className="pb-3">
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                        ...
                        <CardTitle className="text-lg">{t("clients.profile.medicalFile")}</CardTitle>
                    </div>
                    <div className="flex items-center gap-2">
                ...
                <div className="space-y-3 px-6 pb-4 max-h-64 overflow-y-auto">
                    {diagnosis?.results.length === 0 ? (
                        <div className="text-center py-8 text-gray-500">
                            ...
                            <CardDescription>
                                {t("clients.profile.noMedicalFileFound")}
                            </CardDescription>
                        </div>
                    ) : (
                        diagnosis?.results.slice(0, 4).map(({ title, diagnosis_code, created_at, description }, index) => (
                            <div 
                                ...
                                onClick={() => router.push(`/${currentLocale}/clients/${clientId}/medical-record`)}
                            >

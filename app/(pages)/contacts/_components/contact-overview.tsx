...
export function ContactOverview({ contact }: { contact: Contact }) {
  ...
  const copyToClipboard = (text: string) => {
    ...
    // Voeg toast notificatie toe indien nodig
  }

  return (
    <div className="space-y-8">
      {/* Header Sectie met Gradient Achtergrond */}
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        {/* Linkerkolom - Organisatiegegevens */}
            ...
            <CardContent className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-3 p-3 bg-green-50 rounded-lg">
                  ...
                  <div>
                    <p className="text-sm font-medium text-gray-500">BTW Nummer</p>
                    <div className="flex items-center">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3 p-3 bg-purple-50 rounded-lg">
                  ...
                  <div>
                    <p className="text-sm font-medium text-gray-500">Hoofdtelefoon</p>
                ...
                <div className="flex items-center space-x-3 p-3 bg-amber-50 rounded-lg">
                  ...
                  <div>
                    <p className="text-sm font-medium text-gray-500">Lid sinds</p>
            ...
            <CardContent className="p-6">
              {contact.contacts.length === 0 ? (
                <div className="text-center py-8 text-gray-500 rounded-lg bg-gray-50">
                  Geen contactpersonen toegevoegd
                </div>
              ) : (
        ...
        {/* Rechterkolom - Adres en Metadata */}
          ...
          <Card className="border-0 shadow-lg bg-white">
            ...
            <CardContent className="p-6 space-y-4">
              <div className="flex items-center space-x-3 p-3 bg-indigo-50 rounded-lg">
                ...
                <div>
                  <p className="text-sm font-medium text-gray-500">Laatst bijgewerkt</p>
                  <p className="font-medium">{formatDate(contact.updated_at)}</p>
                </div>
              </div>

              <div className="p-4 bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg border border-gray-200">
                <h4 className="font-medium text-gray-800 mb-2">Snelle Acties</h4>

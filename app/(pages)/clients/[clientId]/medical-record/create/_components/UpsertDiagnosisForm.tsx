                                    ...
                                    <FormControl>
                                        <div className="relative">
                                            ...
                                            <div className="absolute right-2 top-0 translate-y-1/2 h-5 w-5 ">
                                                <Tooltip text='Dit is de samenvatting van de diagnose'>
                                ...
                                <FormItem className=''>
                                    ...
                                    <FormControl>
                                        <div className="relative">
                                            ...
                                            <div className="absolute right-2 top-0 translate-y-1/2 h-5 w-5 ">
                                                <Tooltip text='Dit is de ICD code'>
                                                    <Info className='h-5 w-5' />
                                                </Tooltip>
                                            </div>
                                        </div>
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel className='flex items-center justify-between'>
                                        Ernst
                                        <Tooltip text='Dit is de ernst van de diagnose'>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className='col-span-2'>
                                    <FormLabel>Diagnose klinisch specialist</FormLabel>
                                    <FormControl>
                                        <div className="relative">
                                            <Input type="text" placeholder="Diagnose klinisch specialist" {...field} />
                                            <div className="absolute right-2 top-0 translate-y-1/2 h-5 w-5 ">
                                                <Tooltip text='Dit is de klinisch specialist die de diagnose heeft gesteld'>
                                                    <Info className='h-5 w-5' />
                                                </Tooltip>
                                            </div>
                                        </div>
                                ...
                                <FormItem className='col-span-2'>
                                    ...
                                    <FormControl>
                                        <div className="relative">
                                            ...
                                            <div className="absolute right-2 top-0 translate-y-1/2 h-5 w-5 ">
                                                <Tooltip text='Dit is de aandoening'>
                                                    <Info className='h-5 w-5' />
                                                </Tooltip>
                                            </div>
                                        </div>

                ...
                <div className="flex items-center">
                    <Avatar className="h-8 w-8 mr-2">
                        <AvatarFallback className="bg-blue-500 text-white">
                            {clinician ? clinician[0].toUpperCase() : "D"}
                        </AvatarFallback>
                    </Avatar>
                    <span className="text-sm font-medium">{clinician || "Unknown"}</span>
                </div>
            )
        }
    },
                ...
                return (
                    ...
                    >
                        <div className="flex items-center gap-2">
                            ...
                            {med.is_critical && (
                                <span className="text-[8px] text-red-500 font-bold">(CRITICAL)</span>
                            )}
                        </div>
                    ...
                    <Dialog>
                        <DialogTrigger asChild>
                            <Button className="w-fit h-fit hover:bg-gray-500 hover:text-white transition-colors text-xs flex items-center gap-0.5 px-2 py-1 rounded-md border-1 border-gray-500 bg-gray-50 text-gray-600">
                                <span>{medications.length - 1} more</span>
                        ...
                        <DialogContent>
                            <DialogHeader>
                                ...
                                <DialogDescription className="text-sm text-gray-500">
                                    Here are the medications prescribed for this diagnosis.
                                </DialogDescription>
                            </DialogHeader>
                            {
        ...
        cell: (info) => {
            ...
            const calculateDiagnosisPeriod = () => {
                ...
                return {
                    ...
                    end: maxEndDate ? formatDate(maxEndDate) : "Present",
                    ongoing: !maxEndDate
                };
            };

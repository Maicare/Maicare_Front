...
const ObjectivesDetails = ({ assessmentId, clientId }: { clientId: string, assessmentId: string }) => {
            ...
            <CardContent className="grid grid-cols-1 gap-4 p-0">
                {isLoading ? (
                    ...
                    <div className="w-full grid grid-cols-1 gap-4">
                        ...
                        <DataTable columns={[]} data={goals?.results ?? []} onRowClick={handleRowClick} className="dark:bg-[#18181b] dark:border-black" />

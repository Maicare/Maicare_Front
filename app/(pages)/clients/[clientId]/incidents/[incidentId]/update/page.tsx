    ...
    return (
        <div className="container mx-auto">
            <div className="flex justify-between items-center mb-5">
                <h1 className="text-xl font-semibold">Incident bijwerken</h1>
                <p>Dashboard / <span className="font-medium text-indigo-500 hover:cursor-pointer">Incident bijwerken</span></p>
            </div>
            <UpsertIncidentForm
                mode="update"
                onSuccess={onSuccess}

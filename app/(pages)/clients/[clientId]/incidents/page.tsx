    ...
    return (
        <div className="w-full flex flex-col gap-4">
            ...
            {/* <div className="w-full grid lg:grid-cols-[repeat(4,280px)] grid-cols-[repeat(3,205px)] md:grid-cols-[repeat(4,205px)] justify-between mb-5 ">
                ...
                <StatisticCard colorKey="sky" icon={AlarmClock} title="Gem. oplossingstijd" value={3} prefix='Dagen' className='lg:w-[280px] ' />
                <StatisticCard colorKey="pink" icon={Timer} title="Gem. reactietijd" value={4} prefix='Uren' className='lg:w-[280px] ' />
                <StatisticCard colorKey="orange" icon={TriangleAlert} title="Overtr. percentage" value={8} prefix='%' className='lg:w-[280px] ' />
            </div> */}
                        ...
                        : incidents?.results?.length === 0 ?
                            <div className="col-span-4 w-full flex items-center justify-center">
                                <LargeErrorMessage
                                    firstLine={"Oeps!"}
                                    secondLine={
                                        "Het lijkt erop dat er geen incidenten zijn die aan uw zoekcriteria voldoen."
                                    }
                                    className="w-full"
                                />
                            </div>

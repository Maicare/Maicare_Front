        ...
        <Form {...form} >
            <form onSubmit={form.handleSubmit(onSubmit)} className="grid grid-cols-2 gap-4">
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormLabel className='flex items-center justify-between'>
                                                ...
                                                <Tooltip text='Dit is de betrokkenheid van de melder'>
                                                    <Info className='h-5 w-5 mr-2' />
                                                </Tooltip>
                                            </FormLabel>
                                            <FormControl>
                                                <Select onValueChange={field.onChange} defaultValue={field.value} >
                                                    <SelectTrigger className="w-full">
                                                        <SelectValue placeholder="Betrokkenheid melder" />
                                                    </SelectTrigger>
                                                    <SelectContent className="bg-white">
                                                        <SelectGroup>
                                                            {
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="flex flex-col">
                                            <FormLabel className='flex items-center justify-between'>
                                                ...
                                                <Tooltip text='Dit is de datum waarop het incident is ontstaan'>
                                                    <Info className='h-5 w-5 mr-2' />
                                                </Tooltip>
                                            </FormLabel>
                                            <Popover>
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="col-span-2 grid grid-cols-2 gap-x-2 gap-y-4">
                                            <FormLabel className='col-span-2 flex items-center justify-between'>
                                                ...
                                                <Tooltip text='Dit zijn de personen die geïnformeerd moeten worden'>
                                                    <Info className='h-5 w-5 mr-2' />
                                                </Tooltip>
                                            </FormLabel>
                                            {
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className='col-span-2'>
                                            <FormLabel>Looptijd incident</FormLabel>
                                            <FormControl>
                                                <div className="relative">
                                                    <Input type="text" placeholder="Looptijd incident" {...field} />
                                                    <div className="absolute right-2 top-0 translate-y-1/2 h-5 w-5 ">
                                                        <Tooltip text='Dit is de looptijd van het incident'>
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="col-span-2 grid grid-cols-3 gap-x-2 gap-y-4">
                                            <FormLabel className='col-span-3 flex items-center justify-between'>
                                                Technisch
                                                <Tooltip text='Dit zijn de technische oorzaken'>
                                                    <Info className='h-5 w-5 mr-2' />
                                                </Tooltip>
                                            </FormLabel>
                                            {
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="col-span-2 grid grid-cols-3 gap-x-2 gap-y-4">
                                            <FormLabel className='col-span-3 flex items-center justify-between'>
                                                Organisatorisch
                                                <Tooltip text='Dit zijn de organisatorische oorzaken'>
                                                    <Info className='h-5 w-5 mr-2' />
                                                </Tooltip>
                                            </FormLabel>
                                            {
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="col-span-2 grid grid-cols-3 gap-x-2 gap-y-4">
                                            <FormLabel className='col-span-3 flex items-center justify-between'>
                                                Medewerker
                                                <Tooltip text='Dit zijn de medewerker gerelateerde oorzaken'>
                                                    <Info className='h-5 w-5 mr-2' />
                                                </Tooltip>
                                            </FormLabel>
                                            {
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="col-span-2 grid grid-cols-3 gap-x-2 gap-y-4">
                                            <FormLabel className='col-span-3 flex items-center justify-between'>
                                                Cliënt
                                                <Tooltip text='Dit zijn de cliënt gerelateerde oorzaken'>
                                                    <Info className='h-5 w-5 mr-2' />
                                                </Tooltip>
                                            </FormLabel>
                                            {
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className='col-span-2 '>
                                            ...
                                            <FormControl>
                                                <div className="relative">
                                                    <Input placeholder="Bijvoorbeeld: oorzaak" {...field} />
                                                    <div className="absolute right-2 top-0 translate-y-1/2 h-5 w-5 ">
                                                        <Tooltip text='Dit is een overige oorzaak'>
                                                            <Info className='h-5 w-5' />
                                                        </Tooltip>
                                                    </div>
                                                </div>
                                    ...
                                    render={({ field }) => (
                                        <FormItem className='col-span-2 '>
                                            <FormLabel className='flex items-center justify-between text-sm text-slate-700 font-semibold'>
                                                ...
                                                <Tooltip text='Dit is een toelichting op de oorzaak of oorzaken'>
                                                    <Info className='h-5 w-5 mr-2' />
                                                </Tooltip>
                                            </FormLabel>
                                            <FormControl>
                ...
                <div className="grid grid-cols-1 gap-2 h-fit">
                    <div className="grid grid-cols-1 gap-4 h-fit">
                        <div className="flex flex-col gap-4 px-6 py-3 bg-white rounded-md border-2 border-muted h-fit">
                            <h1 className='text-base font-semibold text-black'>Informatie over het incident</h1>
                            <Separator className='bg-slate-300' />
                            <div className="grid grid-cols-2 gap-x-2 gap-y-4">
                                <FormField
                                    control={form.control}
                                    ...
                                    render={({ field }) => (
                                        <FormItem className='col-span-2 '>
                                            <FormLabel className='flex items-center justify-between'>
                                                Type incident
                                                <Tooltip text='Dit is het type incident'>
                                                    <Info className='h-5 w-5 mr-2' />
                                                </Tooltip>
                                            </FormLabel>
                                            <FormControl>
                                ...
                                <FormField
                                    ...
                                    render={({ field: _field }) => (
                                        <FormItem className="col-span-2 grid grid-cols-2 gap-x-2 gap-y-4">
                                            <FormLabel className='col-span-2 flex items-center justify-between'>
                                                Opties
                                                <Tooltip text='Dit zijn de incident type opties'>
                                                    <Info className='h-5 w-5 mr-2' />
                                                </Tooltip>
                                            </FormLabel>
                                            {
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormLabel className='flex items-center justify-between'>
                                                Ernst incident
                                                <Tooltip text='Dit is de ernst van het incident'>
                                                    <Info className='h-5 w-5 mr-2' />
                                                </Tooltip>
                                            </FormLabel>
                                            <FormControl>
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormLabel className='flex items-center justify-between'>
                                                ...
                                                <Tooltip text='Dit geeft aan of er risico is op herhaling van het incident'>
                                                    <Info className='h-5 w-5 mr-2' />
                                                </Tooltip>
                                            </FormLabel>
                                            <FormControl>
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormLabel className='flex items-center justify-between text-sm text-slate-700 font-semibold'>
                                                Welke stappen zijn ondernomen om het incident te voorkomen
                                                <Tooltip text='Dit zijn de stappen die zijn ondernomen om het incident te voorkomen'>
                                                    <Info className='h-5 w-5 mr-2' />
                                                </Tooltip>
                                            </FormLabel>
                                            <FormControl>
                                                <Textarea
                                                    placeholder="Welke stappen zijn ondernomen om het incident te voorkomen"
                                                    className="resize-none"
                                                    rows={3}
                                                    {...field}
                                                />
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormLabel className='flex items-center justify-between text-sm text-slate-700 font-semibold'>
                                                ...
                                                <Tooltip text='Dit zijn de maatregelen die zijn genomen na het incident'>
                                                    <Info className='h-5 w-5 mr-2' />
                                                </Tooltip>
                                            </FormLabel>
                                            <FormControl>
                                    ...
                                    render={({ field }) => (
                                        <FormItem className='col-span-2 '>
                                            <FormLabel className='flex items-center justify-between text-sm text-slate-700 font-semibold'>
                                                ...
                                                <Tooltip text='Dit is een toelichting op het incident'>
                                                    <Info className='h-5 w-5 mr-2' />
                                                </Tooltip>
                                            </FormLabel>
                                            <FormControl>
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className='col-span-2 '>
                                            <FormLabel className='flex items-center justify-between'>
                                                Lichamelijk letsel
                                                <Tooltip text='Dit geeft aan of er lichamelijk letsel is'>
                                                    <Info className='h-5 w-5 mr-2' />
                                                </Tooltip>
                                            </FormLabel>
                                            <FormControl>
                                                <Select onValueChange={field.onChange} defaultValue={field.value} >
                                                    <SelectTrigger className="w-full text-start">
                                                        <SelectValue className='!text-start' placeholder="Lichamelijk letsel" />
                                                    </SelectTrigger>
                                                    <SelectContent className="bg-white">
                                                        <SelectGroup>
                                                            {
                                    ...
                                    render={({ field }) => (
                                        <FormItem className='col-span-2 '>
                                            <FormLabel className='flex items-center justify-between text-sm text-slate-700 font-semibold'>
                                                ...
                                                <Tooltip text='Dit is een omschrijving van het lichamelijk letsel'>
                                                    <Info className='h-5 w-5 mr-2' />
                                                </Tooltip>
                                            </FormLabel>
                                            <FormControl>
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className='col-span-2 '>
                                            <FormLabel className='flex items-center justify-between'>
                                                Psychische schade
                                                <Tooltip text='Dit geeft aan of er psychische schade is'>
                                                    <Info className='h-5 w-5 mr-2' />
                                                </Tooltip>
                                            </FormLabel>
                                            <FormControl>
                                    ...
                                    render={({ field }) => (
                                        <FormItem className='col-span-2 '>
                                            <FormLabel className='flex items-center justify-between text-sm text-slate-700 font-semibold'>
                                                ...
                                                <Tooltip text='Dit is een omschrijving van de psychologische schade'>
                                                    <Info className='h-5 w-5 mr-2' />
                                                </Tooltip>
                                            </FormLabel>
                                            <FormControl>
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className='col-span-2 '>
                                            <FormLabel className='flex items-center justify-between'>
                                                Consult nodig
                                                <Tooltip text='Dit geeft aan of er consult nodig is'>
                                                    <Info className='h-5 w-5 mr-2' />
                                                </Tooltip>
                                            </FormLabel>
                                            <FormControl>
                            ...
                            <div className="grid grid-cols-2 gap-x-2 gap-y-4">
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="col-span-2 grid grid-cols-3 gap-x-2 gap-y-4">
                                            <FormLabel className='col-span-3 flex items-center justify-between'>
                                                Opvolging
                                                <Tooltip text='Dit zijn de opvolgingsacties'>
                                                    <Info className='h-5 w-5 mr-2' />
                                                </Tooltip>
                                            </FormLabel>
                                            {
                                    ...
                                    render={({ field }) => (
                                        <FormItem className='col-span-2 '>
                                            <FormLabel className='flex items-center justify-between text-sm text-slate-700 font-semibold'>
                                                ...
                                                <Tooltip text='Dit is een beschrijving van de opvolging'>
                                                    <Info className='h-5 w-5 mr-2' />
                                                </Tooltip>
                                            </FormLabel>
                                            <FormControl>
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="col-span-2 grid grid-cols-3 gap-x-2">
                                            <FormLabel className='col-span-3 flex items-center justify-between'>
                                                Overige, nl.
                                                <Tooltip text='Dit zijn overige opmerkingen'>
                                                    <Info className='h-5 w-5 mr-2' />
                                                </Tooltip>
                                            </FormLabel>
                                    ...
                                    render={({ field }) => (
                                        <FormItem className='col-span-2 '>
                                            <FormLabel className='flex items-center justify-between text-sm text-slate-700 font-semibold'>
                                                ...
                                                <Tooltip text='Dit is een beschrijving van overige opmerkingen'>
                                                    <Info className='h-5 w-5 mr-2' />
                                                </Tooltip>
                                            </FormLabel>
                                            <FormControl>
                                    ...
                                    render={({ field }) => (
                                        <FormItem className='col-span-2 '>
                                            <FormLabel className='flex items-center justify-between text-sm text-slate-700 font-semibold'>
                                                ...
                                                <Tooltip text='Dit zijn aanvullende afspraken'>
                                                    <Info className='h-5 w-5 mr-2' />
                                                </Tooltip>
                                            </FormLabel>
                                            <FormControl>
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className='col-span-2 '>
                                            <FormLabel className='flex items-center justify-between'>
                                                Ziekteverzuim medewerker
                                                <Tooltip text='Dit geeft aan of er ziekteverzuim is bij de medewerker'>
                                                    <Info className='h-5 w-5 mr-2' />
                                                </Tooltip>
                                            </FormLabel>
                                            <FormControl>
                                                <Select onValueChange={field.onChange} defaultValue={field.value} >
                                                    <SelectTrigger className="w-full text-start">
                                                        <SelectValue className='!text-start' placeholder="Ziekteverzuim medewerker" />
                                                    </SelectTrigger>
                                                    <SelectContent className="bg-white">
                                                        <SelectGroup>
                                                            {

    ...
    <AlertDialog>
        ...
        <DropdownMenuContent align="end" className="bg-white">
          ...
          <AlertDialogTrigger asChild>
            ...
            >
              ...
              <span className="text-sm font-medium">Bevestigen</span>
            </DropdownMenuItem>
          </AlertDialogTrigger>
          <AlertDialogTrigger asChild>
      ...
      <AlertDialogContent>
        ...
        <AlertDialogFooter className="w-full grid grid-cols-2 gap-2 space-x-0">
          {
            type === "confirm" && <Button onClick={handleView} className="ml-2 p-2 w-full col-span-2 border-none ring-0 bg-sky-200 px-2 py-1 text-sky-500 hover:bg-sky-400 hover:text-white transition-colors">PDF bekijken</Button>
          }

...
export const columns: ColumnDef<CarePlan>[] = [
                ...
                <div className="flex items-center gap-2">
                    {isActive ? (
                        ...
                        <>
                            ...
                            <span className="text-red-600 dark:text-red-400">Inactief</span>
                        </>
                    )}
                </div>
            );
    ...
    },
    {
        ...
        cell: ({ row }) => {
            ...
            return formatDateToDutch(date,true) || "Niet gespecificeerd";
        },
    },
    {
        ...
        cell: ({ row }) => {
            const date = row.getValue("end_date")
                ...
                : null;
            return date ? formatDateToDutch(date,true) : "Lopend";
        },
    },

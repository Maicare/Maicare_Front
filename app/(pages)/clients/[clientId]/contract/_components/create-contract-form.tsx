        ...
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                <Card className="bg-white">
                    <CardHeader>
                        <CardTitle>Nieuw Contract</CardTitle>
                    ...
                    <CardContent className="space-y-4">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <FormItem>
                                        ...
                                        <Select onValueChange={field.onChange} defaultValue={field.value}>
                                            ...
                                            <SelectContent className="bg-white">
                                                ...
                                                <SelectItem value="accommodation">Accommodatie</SelectItem>
                                            </SelectContent>
                                        </Select>
                                        <FormMessage />
                                    </FormItem>
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel>Zorgnaam</FormLabel>
                                        <FormControl>
                                            <Input placeholder="Thuiszorg" {...field} />
                                        </FormControl>
                                        <FormMessage />
                                    </FormItem>
                                )}
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel>Financieringswet</FormLabel>
                                        <Select onValueChange={field.onChange} defaultValue={field.value}>
                                            <FormControl>
                                                <SelectTrigger>
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel>Financieringsoptie</FormLabel>
                                        <Select onValueChange={field.onChange} defaultValue={field.value}>
                                            <FormControl>
                                                <SelectTrigger>
                            ...
                            {watchCareType === "ambulante" ? (
                                <>
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                <FormLabel>Urentype</FormLabel>
                                                <Select onValueChange={field.onChange} >
                                                    <FormControl>
                                                        <SelectTrigger>
                                                            <SelectValue placeholder="Selecteer urentype" />
                                                        </SelectTrigger>
                                                    </FormControl>
                                                    <SelectContent className="bg-white">
                                                        <SelectItem value="weekly">Wekelijks</SelectItem>
                                                        <SelectItem value="all_period">Volledige periode</SelectItem>
                                                    </SelectContent>
                                                </Select>
                                                <FormMessage />
                                            </FormItem>
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel>Prijs tijdseenheid</FormLabel>
                                        <Select onValueChange={field.onChange} defaultValue={field.value}>
                                            <FormControl>
                                                <SelectTrigger>
                                                    <SelectValue placeholder="Selecteer tijdseenheid" />
                                                </SelectTrigger>
                                            </FormControl>
                                            <SelectContent className="bg-white">
                                                {watchCareType === "accommodation" ? (
                                                    ...
                                                    <>
                                                        <SelectItem value="minute">Per minuut</SelectItem>
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel>Herinneringsperiode (dagen)</FormLabel>
                                        <FormControl>
                                            <Input
                                                type="number"
                                                placeholder="30"
                                        ...
                                        <FormLabel className='flex items-center justify-between'>
                                            ...
                                            <Dialog open={open} onOpenChange={(o) => {setOpen(o);setContractTypeName('')}}>
                                                ...
                                                <DialogContent className="sm:max-w-[425px]">
                                                    <DialogHeader>
                                                        <DialogTitle>Contracttype aanmaken</DialogTitle>
                                                        <DialogDescription>
                                                            Maak een nieuw contracttype aan.
                                                        </DialogDescription>
                                                    </DialogHeader>
                                                    <div className="grid gap-4">
                                                        <div className="grid gap-3">
                                                            <Input
                                                                placeholder="Contracttype naam"
                                                    ...
                                                    <DialogFooter>
                                                        ...
                                                        <Button type="button" disabled={contractTypeName === ""} onClick={() => {if (contractTypeName !== "") {createContractType(contractTypeName);setOpen(false);}}}>Wijzigingen opslaan</Button>
                                                    </DialogFooter>
                                                </DialogContent>
                                            </Dialog>
                                        </FormLabel>

            ...
            <div className="flex flex-wrap items-center gap-2 mt-3">
              <Badge className={`${statusColors[contract.status]} backdrop-blur-sm capitalize`}>
                {contract.status === 'draft' ? 'Concept' : 
                 contract.status === 'approved' ? 'Actief' :
                 contract.status === 'terminated' ? 'Beëindigd' : 'Gestopt'}
              </Badge>
              <Badge className={`${careTypeColors[contract.care_type]} backdrop-blur-sm capitalize`}>
                {contract.care_type === 'ambulante' ? 'Ambulante' : 'Accommodatie'}
              </Badge>
            ...
            <CardContent className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-blue-800">
                      {contract.end_date ? formatDate(contract.end_date) : (
                        <span className="text-amber-600">Lopend</span>
                      )}
                    </p>
                  </div>
                </div>
                ...
                {contract.care_type === "ambulante" && (
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm text-muted-foreground">Uren</p>
                      <p className="font-medium text-blue-800">
                        {contract.hours} <span className="capitalize">
                          {contract.hours_type === 'daily' ? 'dagelijks' :
                           contract.hours_type === 'weekly' ? 'wekelijks' :
                           contract.hours_type === 'monthly' ? 'maandelijks' :
                           contract.hours_type}
                        </span>
                      </p>
                    </div>
              ...
              <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-blue-800">
                      ...
                      <span className="capitalize">
                        {contract.price_time_unit === 'daily' ? 'dag' :
                         contract.price_time_unit === 'weekly' ? 'week' :
                         contract.price_time_unit === 'monthly' ? 'maand' :
                         contract.price_time_unit === 'minute' ? 'minuut' :
                         contract.price_time_unit === 'hourly' ? 'uur' :
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm text-muted-foreground">Herinneringsperiode</p>
                    <p className="font-medium text-blue-800">{contract.reminder_period} dagen</p>
                  </div>
                </div>
              </div>
            </CardContent>
            ...
            <CardContent className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm text-muted-foreground">Financieringswet</p>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm text-muted-foreground">Financieringsoptie</p>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm text-muted-foreground">Cliënt</p>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm text-muted-foreground">Afzender</p>
            ...
            <Card className="border-0 shadow-sm hover:shadow-md transition-all bg-white">
              <CardHeader className="bg-gradient-to-r from-amber-50 to-amber-100 rounded-t-lg">
                <CardTitle className="flex items-center gap-2 text-amber-800">
                  <FileText className="h-5 w-5" />
                  Bijlagen ({(contract.attachment_ids??[]).length})
                </CardTitle>
              </CardHeader>

      ...
      <section className="space-y-4 border-l-4 border-blue-500 pl-5 group transition-all duration-300 hover:border-blue-600">
        ...
        <ul className="space-y-2">
          {items.length > 0 ? (
            ...
            <li className="italic text-gray-400">Geen items</li>
          )}
        </ul>
      </section>
    ),
    ...
    return (
      ...
      >
        <div className="flex flex-col items-center justify-center py-12">
          <LargeErrorMessage
            firstLine="Nog geen afsprakenkaart beschikbaar"
            secondLine="Maak een afsprakenkaart aan om belangrijke afspraken vast te leggen"

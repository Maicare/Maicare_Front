        ...
        <div className={
            ...
            <div className="">
                ...
                <div className="flex items-center justify-between">
                    <h1 className="text-base mt-2 flex items-center gap-1 font-medium p-1 border-b-2 border-cyan-400 text-cyan-500">Rapport {index + 1}</h1>
                    <AlertDialog>
                        ...
                        <AlertDialogContent>
                            <AlertDialogHeader>
                                <AlertDialogTitle className="flex flex-col gap-2 items-center">
                                    ...
                                    <span className="text-lg font-semibold">Rapportage verwijderen</span>
                                </AlertDialogTitle>
                                <AlertDialogDescription className="text-center">
                                    Weet u zeker dat u deze rapportage wilt verwijderen? Deze actie kan niet ongedaan worden gemaakt.

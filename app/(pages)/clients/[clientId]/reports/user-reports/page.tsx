        ...
        <div className="w-full flex flex-col gap-4">
            <div className="flex items-center justify-between">
                <h1 className='flex items-center gap-2 m-0 p-0 font-extrabold text-lg text-slate-600'>
                    <FileUser size={24} className='text-indigo-400' />  Rapportages
                </h1>
                <CreateReportSheet
                        ...
                        : reports?.results?.length === 0 ?
                            <div className="col-span-4 w-full flex items-center justify-center">
                                <LargeErrorMessage
                                    firstLine={"Oeps!"}
                                    secondLine={
                                        "Het lijkt erop dat er nog geen rapportages zijn aangemaakt voor deze cliënt."
                                    }
                                    className="w-full"
                                />
                            </div>
...
export default withAuth(
  withPermissions(UserReports, {
    ...
    requiredPermissions: PermissionsObjects.ViewClientProgressReport, // TODO: Add correct permission
    }),

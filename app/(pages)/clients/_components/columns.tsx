  ...
  const columns: ColumnDef<Client>[] = [
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        const age = client.date_of_birth ? calculateAge(client.date_of_birth) : "N/B";
        const gender = client.gender || "Niet gespecificeerd";

        return (
          <div className="flex flex-col">
            <span className="font-medium text-gray-900">{age} {"jaar"}</span>
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        return (
          <div className="flex flex-col">
            <span className="text-gray-800">{client.location_name || "N/B"}</span>
      ...
      cell: ({ row }) => {
        ...
        return (
          <div className="text-gray-700">
            {intakeDate ? new Date(intakeDate).toLocaleDateString() : "N/B"}
          </div>
        );
      },
    },

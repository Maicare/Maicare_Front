...
const Page = () => {
  ...
  const handleSubcontractorChange = async(checked: boolean) => {
    ...
    try {
      await updateEmployeeIsSubContractor(checked, +employeeId!, { displayProgress: true, displaySuccess: true });
    } catch (error) {
      console.error(error);
    }
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-4 md:p-8">
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          ...
          >
            {employeeContract.is_subcontractor ? "Onderaannemer" : "Werknemer"}
          </Badge>
        </div>
        ...
        <Card className="shadow-lg border-0">
          <CardHeader className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white rounded-t-lg">
            <div className="flex justify-between items-center">
              <div>
                <CardTitle className="text-2xl">Arbeidsovereenkomst</CardTitle>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="grid grid-cols-1 gap-6">
                  ...
                  <div className="space-y-2">
                    {!employeeContract.is_subcontractor && (
                      <div className="p-3 bg-blue-50 rounded-md">
                        <div className="flex justify-between items-center">
                          <span className="text-gray-700">Vaste Uren:</span>
                          <Badge
                            variant="outline"
                            className={
                          ...
                          >
                            {employeeContract.contract_hours}u/week
                          </Badge>
                        </div>
                      </div>
                    )}
                    {employeeContract.is_subcontractor && (
                      <div className="p-3 bg-blue-50 rounded-md">
                        <div className="flex justify-between items-center">
                          <span className="text-gray-700">Variabele Uren:</span>
                          <Badge
                            variant="outline"
                            className={
                              employeeContract.contract_type === 'loondienst'
                ...
                <div className="p-4 bg-white rounded-lg border border-gray-200 shadow-sm">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between">
                      <span className="text-gray-600">Einddatum:</span>
              ...
              <div className="grid grid-cols-1 gap-6">
                <div className="p-4 bg-white rounded-lg border border-gray-200 shadow-sm">
                  ...
                  <div className="p-3 bg-blue-50 rounded-md">
                    <div className="flex justify-between items-center">
                      <span className="text-gray-700">Dienstverband:</span>
                      <Badge
                        variant="outline"
                        className={
                          employeeContract.contract_type === 'loondienst'
                ...
                <div className="p-4 bg-white rounded-lg border border-gray-200 shadow-sm">
                  ...
                  <div className="p-3 bg-blue-50 rounded-md">
                    <div className="flex justify-between items-center">
                      <span className="text-gray-700">Uurtarief:</span>
                      <Badge
                        variant="outline"
                        className={
        ...
        <div className="mt-6 text-center text-sm text-gray-500">
          <p>Dit document vertegenwoordigt de officiële contractovereenkomst. Controleer alle details zorgvuldig.</p>
        </div>
      </div>
    </div>
  )
...
export default withAuth(
  withPermissions(Page, {
    ...
    requiredPermissions: PermissionsObjects.ViewEmployeeContract, // TODO: Voeg correcte permissie toe
  }),

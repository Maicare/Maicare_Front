            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="w-full bg-white p-4 rounded-md shadow-md flex flex-col gap-4">
                <div className="grid grid-cols-2 gap-4">
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                <FormLabel className="text-sm text-slate-700 font-semibold">Diploma</FormLabel>
                                <FormControl>
                                    <div className="relative">
                                        <Input placeholder="bijv: Bachelor Informatica" {...field} />
                                        <div className="absolute right-2 top-0 translate-y-1/2 h-5 w-5 ">
                                            <Tooltip text='Dit is het behaalde diploma'>
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                <FormLabel className="text-sm text-slate-700 font-semibold">Studierichting</FormLabel>
                                <FormControl>
                                    <div className="relative">
                                        <Input placeholder="bijv: Informatica" {...field} />
                                        <div className="absolute right-2 top-0 translate-y-1/2 h-5 w-5 ">
                                            <Tooltip text='Dit is de studierichting'>
                                                <Info className='h-5 w-5' />
                                            </Tooltip>
                                        </div>
                                    </div>
                        ...
                        render={({ field }) => (
                            <FormItem className="flex flex-col">
                                <FormLabel className='flex items-center justify-between text-sm text-slate-700 font-semibold'>
                                    Startdatum
                                    <Tooltip text='Dit is de startdatum'>
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem className="flex flex-col">
                                <FormLabel className='flex items-center justify-between text-sm text-slate-700 font-semibold'>
                                    Einddatum
                                    <Tooltip text='Dit is de einddatum'>
                                        <Info className='h-5 w-5 mr-2' />
                                    </Tooltip>
                                </FormLabel>
                                <Popover>
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                <FormLabel className="text-sm text-slate-700 font-semibold">Onderwijsinstelling</FormLabel>
                                <FormControl>
                                    <div className="relative">
                                        <Input placeholder="bijv: Universiteit van Amsterdam" {...field} />
                                        <div className="absolute right-2 top-0 translate-y-1/2 h-5 w-5 ">
                                            <Tooltip text='Dit is de onderwijsinstelling'>
                                                <Info className='h-5 w-5' />
                                            </Tooltip>
                                        </div>
                                    </div>

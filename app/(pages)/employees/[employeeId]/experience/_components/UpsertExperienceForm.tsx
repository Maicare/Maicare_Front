            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="w-full bg-white p-4 rounded-md shadow-md flex flex-col gap-4">
                <div className="grid grid-cols-2 gap-4">
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                <FormLabel className="text-sm text-slate-700 font-semibold">Functie</FormLabel>
                                <FormControl>
                                    <div className="relative">
                                        <Input placeholder="bijv: Full-stack developer" {...field} />
                                        <div className="absolute right-2 top-0 translate-y-1/2 h-5 w-5 ">
                                            <Tooltip text='Dit is de functietitel'>
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                <FormLabel className="text-sm text-slate-700 font-semibold">Bedrijf</FormLabel>
                                <FormControl>
                                    <div className="relative">
                                        <Input placeholder="bijv: Microsoft" {...field} />
                                        <div className="absolute right-2 top-0 translate-y-1/2 h-5 w-5 ">
                                            <Tooltip text='Dit is het bedrijf'>
                                                <Info className='h-5 w-5' />
                                            </Tooltip>
                                        </div>
                                    </div>
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                <FormLabel className='flex items-center justify-between text-sm text-slate-700 font-semibold'>
                                    Omschrijving
                                    <Tooltip text='Dit is de functieomschrijving'>
                                        <Info className='h-5 w-5 mr-2' />
                                    </Tooltip>
                                </FormLabel>
                                <FormControl>
                                    <Textarea
                                        placeholder="Vertel ons iets over uw functie en verantwoordelijkheden"

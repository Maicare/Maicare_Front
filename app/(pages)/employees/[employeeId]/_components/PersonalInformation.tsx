    ...
    return (
        <div className="w-[32%] h-[287px] rounded-sm shadow-md p-4 bg-white">
            ...
            <p className="mt-4 text-slate-400">
                Hier vindt u de persoonlijke basisinformatie van de medewerker, inclusief contactgegevens en locatie.
            </p>
            <div className="mt-4 w-full">
                ...
                <div className="flex items-center w-full py-2 border-b border-slate-200">
                    <p className="w-[40%] text-sm text-slate-600 font-bold">Telefoon:</p>

        ...
        return (
            <Card className="w-full h-full border-2 border-dashed border-gray-200 hover:border-indigo-300 transition-colors">
                <CardContent className="p-6 flex flex-col items-center justify-center h-full text-center">
                    ...
                    <CardTitle className="text-lg mb-2">Betrokken Medewerkers</CardTitle>
                    <CardDescription className="mb-4">
                        Geen betrokken medewerkers toegewezen aan deze cliënt
                    </CardDescription>
                    <Button 
            ...
            <CardHeader className="pb-3">
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                        ...
                        <CardTitle className="text-lg">Betrokken Medewerkers</CardTitle>
                    </div>
                    <div className="flex items-center gap-2">

                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className='col-span-2'>
                                    ...
                                    <FormControl>
                                        <div className="relative">
                                            <Input type='email' placeholder="eg: John@gmail.com" {...field} />
                                            <div className="absolute right-2 top-0 translate-y-1/2 h-5 w-5 ">
                                                <Tooltip text='This is E-mailadres'>
                                                    <Info className='h-5 w-5' />
                                                </Tooltip>
                                            </div>
                                        </div>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className='col-span-2'>
                                    ...
                                    <FormControl>
                                        <div className="relative">
                                            <Input placeholder="eg: +212 626272829" {...field} />
                                            <div className="absolute right-2 top-0 translate-y-1/2 h-5 w-5 ">

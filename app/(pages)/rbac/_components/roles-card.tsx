...
const RolesCard = ({
    ...
    const handleCreateRole = async () => {
        try {
            ...
            console.error("Mislukt om rol aan te maken:", error);
        }
    }
    ...
    const handleUserRoleChange = async (userId: number, roleId: string) => {
        try {
            ...
            console.error("Mislukt om gebruikersrol bij te werken:", error);
        }
    }
            ...
            <Card className="bg-white border-indigo-100 shadow-sm">
                <CardHeader className="bg-gradient-to-r from-indigo-500 to-purple-600 text-white rounded-t-lg py-4">
                    ...
                    <CardDescription className="text-indigo-100">
                        Beheer en wijs permissies toe aan rollen
                    </CardDescription>
                </CardHeader>
                <CardContent className="p-4">
                        ...
                        {(filteredRoles ?? []).slice(0, 4).map(role => (
                            ...
                            >
                                <div className="flex justify-between items-center">
                                    ...
                                    >
                                        {role.permission_count} permissies
                                    </Badge>
                                </div>
                            </div>
                        ))}
                    ...
                    <div className="mt-6">
                        <Label htmlFor="newRole" className="text-indigo-800">Nieuwe Rol Aanmaken</Label>

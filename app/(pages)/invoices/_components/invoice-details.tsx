...
export default function InvoiceDetails({ invoice, handleCredit, onRefetch, handleReminder }: { invoice: InvoicesType, handleCredit: () => void, onRefetch: () => void, handleReminder: () => void }) {
    ...
    const totalAmount = new Intl.NumberFormat("nl-NL", {
        style: "currency",
        currency: "EUR",
    ...
    // Bereken betalingsvoortgang (voor gedeeltelijk betaald)
    const paymentProgress = status === "partially_paid" ? 50 : status === "paid" ? 100 : 0

    return (
        <div className="container mx-auto px-4 py-8">
            {/* Header met terugknop en acties */}
                                ...
                                <div className="flex items-center mt-2">
                                    ...
                                    {isOverdue && (
                                        <Badge variant="destructive" className="ml-3 animate-pulse">
                                            {daysOverdue} {daysOverdue === 1 ? "Dag Achterstallig" : "Dagen Achterstallig"}
                                        </Badge>
                                    )}
                                </div>
                            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 space-y-6">
                                        ...
                                        <div className="flex flex-col md:flex-row justify-between gap-4">
                                            ...
                                            <div className="text-right">
                                                ...
                                                <div className="text-sm text-muted-foreground">
                                                    {detail.price} € {detail.price_time_unit} • {detail.vat}% BTW
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <PaymentOverview invoiceId={invoice.id.toString()} onRefetch={onRefetch} />
                ...
                <div className="space-y-6">
                        ...
                        <CardContent>
                            <div className="space-y-4">
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-muted-foreground">
                                            {format(new Date(invoice.created_at), "MMM dd, yyyy 'om' HH:mm")}
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        <p className="font-medium">Uitgegeven</p>
                                        <p className="text-sm text-muted-foreground">
                                ...
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        <p className={`font-medium ${isOverdue ? "text-red-600 dark:text-red-400" : ""}`}>
                                            Vervaldatum {isOverdue && "(Achterstallig)"}
                                        </p>
                                        <p className="text-sm text-muted-foreground">
                                ...
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-muted-foreground">
                                            {format(new Date(invoice.updated_at), "MMM dd, yyyy 'om' HH:mm")}
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <Card className="border-0 shadow-sm bg-gradient-to-br from-green-50 to-teal-50/30 dark:from-green-900/20 dark:to-teal-900/10">
                        <CardHeader className="pb-3">
                            <CardTitle className="flex items-center">
                                ...
                                <span>Betalingssamenvatting</span>
                            </CardTitle>
                        </CardHeader>
                        <CardContent>
                            <div className="space-y-4">
                                ...
                                <div className="border-t pt-3 flex justify-between">
                                    <p className="text-sm font-medium">Totaalbedrag</p>
                    ...
                    <div className="space-y-3">
                        ...
                        <Button onClick={() => {
                            handleReminder();
                        }} variant="outline" className="w-full rounded-full border-blue-200 hover:bg-blue-50/50 dark:hover:bg-blue-900/20 h-12 backdrop-blur-sm">
